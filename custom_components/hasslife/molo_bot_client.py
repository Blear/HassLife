...
class MoloBotClient(asyncore.dispatcher):
    """Client protocol class for Molobot."""
    white_domains = ['binary_sensor','sensor','light','cover','switch','vacuum','water_heater','humidifier','fan','media_player','script','climate','input_boolean','automation','group','lock']
